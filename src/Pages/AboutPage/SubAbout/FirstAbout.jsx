  ...
  return (
    <div className='AboutPage-Main'>
      <div className="sub-AboutPage-Main">
        ...
        <p>🚀I build clean, responsive, engaging, and accessible digital experiences.</p>
        <p>💻I enjoy playing with latest web technologies and continuously 
          strive to improve my skill and knowlege.</p>
    <div className="socialLinks-About">
      ...
      <a href="https://www.linkedin.com/in/saif-rehman-professional/" target='_blank'>
      <span>
      ...
      <a href="https://www.instagram.com/safiking_001?igsh=YzljYTk1ODg3Zg==" target='_blank'>
      <span>
      ...
      <span>
      <svg fill="#ffffff" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M19,19H1c-0.6,0-1-0.4-1-1v-5h2v4h16v-4h2v5C20,18.6,19.6,19,19,19z"></path> <path d="M15.7,7.3c-0.4-0.4-1-0.4-1.4,0L11,10.6V2c0-0.6-0.4-1-1-1S9,1.4,9,2v8.6L5.7,7.3c-0.4-0.4-1-0.4-1.4,0s-0.4,1,0,1.4l5,5 c0.4,0.4,1,0.4,1.4,0l5-5C16.1,8.3,16.1,7.7,15.7,7.3z"></path> </g></svg>
      </span>
      </a>
    </div>
      </div>
      <div className="sub-AboutPage-Main">
        ...
        One of my strongest qualities as a <a href="https://www.coursera.org/articles/mern-stack" target='_blank'>MERN</a>  stack developer is my
                  ...
                  complete projects on time and to the highest standards.
        </p>
        {/* <p>
        ...
        I am also a strong <a href=""> communicator</a> and able to effectively
                 ...
                 <a href=""> web solutions </a>that meet the needs of my clients and exceed
                  their expectations.
                
        </p>
        <p>
          
        In my free time, I enjoy hobbies such as  watching
                  movies, and <a href=""> traveling </a>. I am also an avid learner and am always
                  looking for ways to improve my skills and knowledge. In
                  addition to my <a href=""> technical skills</a> I am excited to work with
